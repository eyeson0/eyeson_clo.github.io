  ...
  mount.innerHTML =
    '<header class="site-header" id="siteHeader">' +
      '<div class="header-inner">' +
        ...
        "</nav>" +
        /* Center: official logo — replace images/logo/logo.png, updates everywhere */
        '<a class="logo-link" href="index.html" aria-label="EYESON home">' +
          '<img src="images/logo/logo.png" alt="EYESON" onerror="this.outerHTML=\'<span class=&quot;logo-fallback&quot;>EYESON</span>\'"/>' +
        "</a>" +
        /* Right: icon rail */
        '<div class="header-icons">' +
          '<button class="icon-btn" id="searchBtn" aria-label="Search">' + ICONS.search + "</button>" +
          '<a class="icon-btn" href="wishlist.html" aria-label="Wishlist">' + ICONS.heart + "</a>" +
...
function renderFooter() {
  ...
  mount.innerHTML =
    '<footer class="site-footer">' +
      '<div class="container">' +
        /* Centered logo */
        '<div class="footer-logo"><a href="index.html"><img src="images/logo/logo.png" alt="EYESON" onerror="this.outerHTML=\'<span class=&quot;logo-fallback&quot;>EYESON</span>\'"/></a></div>' +
...
function renderChrome() {
  ...
  /* Custom focus-ring cursor (desktop pointers only) */
  if (window.matchMedia("(hover: hover) and (pointer: fine)").matches) {
    const ring = document.createElement("div");
    ring.className = "cursor-ring"; document.body.appendChild(ring);
    document.addEventListener("mousemove", (e) => {
      ring.style.left = e.clientX + "px";
      ring.style.top = e.clientY + "px";
    });
    /* Expand on products, pulse on buttons, eye-shape on models */
    document.addEventListener("mouseover", (e) => {
      ring.classList.toggle("hover-product", !!e.target.closest(".product-card, .search-result, .insta-item"));
      ring.classList.toggle("hover-btn", !!e.target.closest(".btn, button"));
      ring.classList.toggle("hover-model", !!e.target.closest(".mc-model"));
    });
  }
}
